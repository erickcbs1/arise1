...
local HackFramework = {}
local GuiManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/username/repository/main/gui/manager.lua"))()
local ModuleManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/username/repository/main/modules/manager.lua"))()
local Utils = loadstring(game:HttpGet("https://raw.githubusercontent.com/username/repository/main/utils.lua"))()
